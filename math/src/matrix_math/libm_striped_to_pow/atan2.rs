...
use crate::matrix_math::libm_striped_to_pow::atan::atan;
use crate::matrix_math::libm_striped_to_pow::fabsf::fabsf;

const PI: f32 = 3.1415926535897931160E+00; /* 0x400921FB, 0x54442D18 */
const PI_LO: f32 = 1.2246467991473531772E-16; /* 0x3CA1A626, 0x33145C07 */
