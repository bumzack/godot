...
pub fn atan(x: f32) -> f32 {
    ...
    if ix >= 0x4410_0000 {
        ...
        let z = ATANHI[3] + f32::from_bits(0x0380_0000); // 0x1p-120f
...
mod tests {
    ...
    #[test]
    fn infinity() {
        assert_eq!(atan(f32::INFINITY), f32::consts::FRAC_PI_2);
    }

    #[test]
    fn minus_infinity() {
        assert_eq!(atan(f32::NEG_INFINITY), -f32::consts::FRAC_PI_2);
    }

    #[test]
    fn nan() {
        assert!(atan(f32::NAN).is_nan());
    }
}
