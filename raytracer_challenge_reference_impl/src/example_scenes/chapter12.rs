...
use crate::prelude::{
    Camera, CameraOps, Checker3DPattern, Color, ColorOps, Cube, GradientPattern, Light, MaterialOps, Matrix, MatrixOps,
    Pattern, PatternEnum, Plane, PointLight, RingPattern, Shape, ShapeOps, Sphere, Tuple, Tuple4D, World, WorldOps,
};

pub fn chapter12(width: usize, height: usize) -> (World, Camera) {
