...
use crate::prelude::{
    Camera, CameraOps, Color, ColorOps, Light, MaterialOps, Matrix, MatrixOps, Plane, PointLight, Shape, ShapeOps,
    Sphere, Tuple, Tuple4D, World, WorldOps,
};

pub fn chapter09(width: usize, height: usize) -> (World, Camera) {
